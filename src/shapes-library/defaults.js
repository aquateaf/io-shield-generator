...
export const DEFAULT_SHAPES = [
  ...
  { id: 'usb-a-dual', name: 'USB-A ×2 (стек)', bezelHeight: 1.3, bezelWidth: 1.2, primitives: [rect(14.5, 15.8, 0.55)] },
  ...
  { id: 'rj11', name: 'RJ11 / модем', bezelHeight: 1.2, bezelWidth: 1.2, primitives: [rect(12.5, 11.5, 0.5)] },
  { id: 'audio', name: 'Аудио 3.5 мм', bezelHeight: 1.1, bezelWidth: 1.1, primitives: [circle(3.25)] },
  { id: 'optical-spdif', name: 'S/PDIF Toslink', bezelHeight: 1.1, bezelWidth: 1.1, primitives: [rect(10.0, 10.0, 0.8)] },
  { id: 'rca', name: 'RCA / коаксиал', bezelHeight: 1.1, bezelWidth: 1.1, primitives: [circle(4.5)] },
  ...
  { id: 'sma-antenna', name: 'Антенна SMA / Wi-Fi', bezelHeight: 1.0, bezelWidth: 1.0, primitives: [circle(3.25)] },
