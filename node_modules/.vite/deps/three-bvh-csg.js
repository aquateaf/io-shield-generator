import { $r as MathUtils, Bo as SphereGeometry, Bs as Vector3, Dr as Line3, J as BufferGeometry, Nr as LineSegments, Or as LineBasicMaterial, Qn as InstancedMesh, Rn as Group, U as Box3, Vs as Vector4, _s as Triangle, ai as MeshBasicMaterial, di as MeshPhongMaterial, ii as Mesh, lo as Ray, ni as Matrix4, q as BufferAttribute, ra as Plane, st as Color, ti as Matrix3, zs as Vector2 } from "./three.module-BEvS_7fE.js";
...
var HalfEdgeHelper = class extends EdgesHelper {
	...
	setHalfEdges(geometry, halfEdges) {
		...
		if (displayDisconnectedEdges) {
			if (halfEdges.unmatchedDisjointEdges) halfEdges.unmatchedDisjointEdges.forEach(({ forward, reverse, ray }) => {
